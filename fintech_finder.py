...
# web interface.
  ...
  #st.sidebar.write("If you hire", candidate, "for", wage, "eth, your account balance will be", new_balance, ".")
  #get_people()
#else:
  #st.sidebar.write("With a balance of", ether, "ether, you can't hire", candidate, "for", wage, "eth." )
  #get_people()
